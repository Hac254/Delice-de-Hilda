          ...
          <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="w-full md:w-1/2">
              <p className="text-gray-600 mb-6">
                Welcome to Délice de Hilda! I&apos;m Hilda, the passionate baker behind every delicious creation you see here.
                At Délice de Hilda, we believe every celebration deserves a perfect centerpiece. Our passion for creating
      ...
      <footer className="bg-gradient-to-br from-blue-800 to-blue-900 text-white py-8 md:py-12 w-full">
        ...
        <div className="container mx-auto px-4 mt-8 pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-white/70">
            <p>© {new Date().getFullYear()} Délice de Hilda. All rights reserved.</p>
            <a 
